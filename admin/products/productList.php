...
$sql = "SELECT products.*,category.* from products,category where products.category_id=category.id order by product_id desc limit $start , $num_per_page";
